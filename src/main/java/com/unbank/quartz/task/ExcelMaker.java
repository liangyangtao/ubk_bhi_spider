...
public class ExcelMaker {
	...
	public static void main(String[] args) {
		...
		String startTime = SimpleTools.getyyyyMMddTimeString(new Date(), -2);
		String endTime = SimpleTools.getyyyyMMddTimeString(new Date(), -2);
		new ExcelMaker().makeExcel(startTime, endTime);
	...
	private String makeExcelFile(String startTime, String endTime,
		...
		String path = null;
		try {
			path = ExcelMaker.class.getClassLoader().getResource("").toURI()
					.getPath();
	...
	private void makeSurveyExcel(List<BhiProWithBLOBs> bhiPros, XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_survey");
		// 定义 row、cell
		XSSFRow row;
	...
	private void makePrimaryDesignExcel(List<BhiProWithBLOBs> bhiPros,
			XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_primary_design");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makePlantExcel(List<BhiProWithBLOBs> bhiPros, XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_plant");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makeFeasibilityStudyExcel(List<BhiProWithBLOBs> bhiPros,
			XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_feasibility_study");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makeEnvironmentalAssessmentExcel(
			List<BhiProWithBLOBs> bhiPros, XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_environmental_assessment");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makeConstructionExcel(List<BhiProWithBLOBs> bhiPros,
			XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_construction");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makeDesignExcel(List<BhiProWithBLOBs> bhiPros, XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_design");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
	...
	private void makeOwnerExcel(List<BhiProWithBLOBs> bhiPros, XSSFWorkbook xwb) {
		XSSFSheet sheet = xwb.createSheet("bhi_owner");
		// 定义 row、cell
		XSSFRow row;
		row = sheet.createRow(0);
